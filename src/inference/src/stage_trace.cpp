...
void stage_trace_logits(const char *phase, const char *prompt_id, uint32_t step,
  ...
  oss << ",\"phase\":\"" << phase << "\""
      ...
      << ",\"seq_len\":" << seq_len << ",\"tokens_total\":"
      << tokens_total << ",\"hash\":" << stats.hash
      << ",\"min\":" << stats.min << ",\"max\":" << stats.max
      << ",\"mean\":" << stats.mean << ",\"top1_id\":" << stats.top1_id
      << ",\"top1_logit\":" << stats.top1_logit
      << ",\"top2_id\":" << stats.top2_id
      << ",\"top2_logit\":" << stats.top2_logit
      << ",\"gap\":" << stats.gap << ",\"vocab\":" << stats.vocab
      << ",\"logits_ptr\":" << stats.logits_ptr
