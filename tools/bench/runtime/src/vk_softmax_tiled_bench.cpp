...
int main(int argc, char **argv) {
  ...
  std::cout << "GRETA CORE Runtime Bench: vk_softmax_tiled_bench\n";
  ...
  if (timing_ok) {
    ...
    std::cout << "RESULT vk_softmax_tiled_bench: mean_ms=" << mean
  ...
  std::cout << "VALIDATION(softmax_tiled): "
            << (validation_ok ? "OK" : "FAILED") << " max_abs_sum="
            << max_abs_sum << " max_abs_err=" << max_abs << "\n";
