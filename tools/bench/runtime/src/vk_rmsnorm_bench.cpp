...
int main(int argc, char **argv) {
  ...
  std::cout << "GRETA CORE Runtime Bench: vk_rmsnorm_bench\n";
  ...
  if (timing_ok) {
    ...
    std::cout << "RESULT vk_rmsnorm_bench: mean_ms=" << mean
  ...
  std::cout << "VALIDATION(rmsnorm): " << (validation_ok ? "OK" : "FAILED")
            << " max_abs_err=" << max_abs << "\n";
