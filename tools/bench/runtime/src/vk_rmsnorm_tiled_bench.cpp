...
int main(int argc, char **argv) {
  ...
  std::cout << "GRETA CORE Runtime Bench: vk_rmsnorm_tiled_bench\n";
  ...
  gcore::rt::vk::Buffer x_dev{}, g_dev{}, y_dev{};
  gcore::rt::vk::Buffer x_stage{}, g_stage{}, y_stage{};
  auto cleanup = [&]() {
  ...
  if (timing_ok) {
    ...
    std::cout << "RESULT vk_rmsnorm_tiled_bench: mean_ms=" << mean
  ...
  rmsnorm_ref(x_host.data(), ref.data(), g_host.data(), rows, cols, eps);
  ...
  std::cout << "VALIDATION(rmsnorm_tiled): "
