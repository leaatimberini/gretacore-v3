...
int main(int argc, char **argv) {
  ...
  std::cout << "GRETA CORE Runtime Bench: vk_layernorm_rmsnorm_fused_bench\n";
  ...
  if (timing_ok) {
    ...
    std::cout << "RESULT vk_layernorm_rmsnorm_fused_bench: mean_ms=" << mean
  ...
  std::cout << "VALIDATION(layernorm_rmsnorm_fused): "
