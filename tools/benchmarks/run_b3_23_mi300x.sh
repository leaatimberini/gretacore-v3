...
OUTDIR_LOCAL="$ROOT_DIR/artifacts_remote/${DATE}/b3_23"
...
tar -czf /root/gretacore_b3_23_artifacts.tgz \
  $OUTDIR/b3_23_attn_softmax.jsonl \
  $OUTDIR/b3_23_p4.log \
  $OUTDIR/b3_23_p5.log
...
tar -xzf "$OUTDIR_LOCAL/gretacore_b3_23_artifacts.tgz" -C "$OUTDIR_LOCAL/"

python3 tools/benchmarks/analyze_b3_23_softmax.py \
  --jsonl "$OUTDIR_LOCAL/root/gretacore/artifacts/alignment/$DATE/b3_23_attn_softmax.jsonl" \
  --out "$OUTDIR_LOCAL/b3_23_analysis.txt"
